...
export const div = (
  attributes: IAttribute | Partial<HTMLDivElement>,
  ...childNodes: HTMLElement[] | Component<any, any>[]
) => generateElement('div', attributes, ...childNodes)

export const a = (
  attributes: IAttribute | Partial<HTMLAnchorElement>,
  ...childNodes: HTMLElement[] | Component<any, any>[]
) => generateElement('a', attributes, ...childNodes)

export const p = (
  attributes: IAttribute | Partial<HTMLParagraphElement>,
  ...childNodes: HTMLElement[] | Component<any, any>[]
) => generateElement('p', attributes, ...childNodes)

export const span = (
  attributes: IAttribute | Partial<HTMLSpanElement>,
  ...childNodes: HTMLElement[] | Component<any, any>[]
) => generateElement('span', attributes, ...childNodes)

export const button = (
  attributes: IAttribute | Partial<HTMLButtonElement>,
  ...childNodes: HTMLElement[] | Component<any, any>[]
...
export const form = (
  attributes: IAttribute | Partial<HTMLInputElement>,
  ...childNodes: HTMLElement[] | Component<any, any>[]
) => generateElement('form', attributes, ...childNodes)

export const label = (
  attributes: IAttribute | Partial<HTMLLabelElement>,
  ...childNodes: HTMLElement[] | Component<any, any>[]
) => generateElement('label', attributes, ...childNodes)

export const q = (
  attributes: IAttribute | Partial<HTMLQuoteElement>,
  ...childNodes: HTMLElement[] | Component<any, any>[]
...
export const [h1, h2, h3, h4, h5, h6] = [
  ...
  (tagName) => (
    attributes: IAttribute | Partial<HTMLHeadingElement>,
    ...childNodes: HTMLElement[] | Component<any, any>[]
  ) => generateElement(tagName, attributes, ...childNodes)
)
